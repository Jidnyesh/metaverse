...
public class InputBehaviourPrototype : Fusion.Behaviour, INetworkRunnerCallbacks
{
    ...
    public void OnInput(NetworkRunner runner, NetworkInput input)
    {
        ...
        {
            frameworkInput.Buttons |= NetworkInputPrototype.FOR_UP;
        }
        ...
        {
            frameworkInput.Buttons |= NetworkInputPrototype.BACK_UP;
        }
        ...
        {
            frameworkInput.Buttons |= NetworkInputPrototype.LEFT_UP;
        }
        ...
        {
            frameworkInput.Buttons |= NetworkInputPrototype.RIGHT_UP;
        }
